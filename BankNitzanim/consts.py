...
# checking account consts
INITIAL_CHECKING_ACCOUNT = 0
INITIAL_WAGE = 5000

# deposit consts
STARTING_DEPOSIT_AMOUNT = 0
INITIAL_NATIONAL_BANK_DEPOSIT_INTEREST = 5
PRIME = INITIAL_NATIONAL_BANK_DEPOSIT_INTEREST + 1.5
SINGULAR_DEPOSIT = 0
MONTHLY_DEPOSIT = 1
...
BASIC_INTEREST = 3
BASIC_DEPOSIT_TIME = 365
YEAR = 365

# loan consts
INITIAL_NATIONAL_BANK_LOAN_INTEREST = 5
